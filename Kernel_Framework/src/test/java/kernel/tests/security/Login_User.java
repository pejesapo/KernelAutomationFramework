...
public class Login_User {
	...
	public void should_logging_with_correct_credentials() {
		...
		KernelLoginPage loginPage = new KernelHomePage(this.browser).open()
				.goToLoginPage();
	...
	@Test
	public void an_error_message_should_be_displayed_when_logging_in_with_inorrect_credentials() {
		logger.info("Given I'm in Kernel's Home Page");
		...
		logger.info("Then a popup message error should be displayed with the text: "
				+ "<You entered a wrong username or password combination. Try again, or click the Forgot Password link.>");
		assertTrue(loginPage
				.isLoginErrorMessageDisplayed("You entered a wrong username or password combination. "
						+ "Try again, or click the Forgot Password link."));
	}

	//TODO
	@Test
	public void should_logging_with_valid_Google_Account(){
